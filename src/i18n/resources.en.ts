// Généré : agrège tous les namespaces EN en un seul module.
// Importé dynamiquement par config.ts => Vite en fait un chunk séparé, donc un
// joueur ne télécharge que la langue qu'il utilise (et pas les deux).
...
import journalScreenEn from './locales/en/journalScreen.json'
import relicsEn from './locales/en/relics.json'
...
export default {
  common: commonEn,
  goods: goodsEn,
  stationHub: stationHubEn,
  quests: questsEn,
  explorationScenes: explorationScenesEn,
  narrativeArcs: narrativeArcsEn,
  narrativeArcsScreen: narrativeArcsScreenEn,
  marketScreen: marketScreenEn,
  combatScreen: combatScreenEn,
  prisonScreen: prisonScreenEn,
  worldEvents: worldEventsEn,
  blackMarket: blackMarketEn,
  travelEvents: travelEventsEn,
  npcTracker: npcTrackerEn,
  chainEvents: chainEventsEn,
  stationEvents: stationEventsEn,
  memoryEvents: memoryEventsEn,
  arrivalSituations: arrivalSituationsEn,
  stalker: stalkerEn,
  bossHomeVisits: bossHomeVisitsEn,
  subBossResolutions: subBossResolutionsEn,
  armors: armorsEn,
  weapons: weaponsEn,
  classes: classesEn,
  runModifiers: runModifiersEn,
  runObjectives: runObjectivesEn,
  metaUnlocks: metaUnlocksEn,
  raphazarus: raphazarusEn,
  pillarRumors: pillarRumorsEn,
  factions: factionsEn,
  deliveryEvents: deliveryEventsEn,
  npcLore: npcLoreEn,
  majorQuests: majorQuestsEn,
  journalScreen: journalScreenEn,
  relics: relicsEn,
  ...
  stations: stationsEn,
  nexus: nexusEn,
  wikiScreen: wikiScreenEn,
  factionsScreen: factionsScreenEn,
  introScreen: introScreenEn,
  cinematicIntro: cinematicIntroEn,
  combatOutcomeScreen: combatOutcomeScreenEn,
  interrogationQuestions: interrogationQuestionsEn,
  interrogationScreen: interrogationScreenEn,
  mapScreen: mapScreenEn,
  scenarioGame: scenarioGameEn,
  npcEncounterPanel: npcEncounterPanelEn,
  gameStore: gameStoreEn,
  craftingScreen: craftingScreenEn,
  exploreResultPanel: exploreResultPanelEn,
  wanderResultPanel: wanderResultPanelEn,
  inventoryScreen: inventoryScreenEn,
  nexusScreen: nexusScreenEn,
  questsScreen: questsScreenEn,
  shipWorkshopScreen: shipWorkshopScreenEn,
  travelScreen: travelScreenEn,
  outcomeInterpreter: outcomeInterpreterEn,
  equipmentQuests: equipmentQuestsEn,
  objectivesScreen: objectivesScreenEn,
  consumables: consumablesEn,
  combat: combatEn,
  multiCombat: multiCombatEn,
  minigames: minigamesEn,
  classSelect: classSelectEn,
  combatResultScreen: combatResultScreenEn,
  hubPanels: hubPanelsEn,
  loreScreen: loreScreenEn,
  multiCombatScreen: multiCombatScreenEn,
  stationArrivalScreen: stationArrivalScreenEn,
