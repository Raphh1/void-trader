// Généré : agrège tous les namespaces FR en un seul module.
...
import runStoryFr from './locales/fr/runStory.json'
...
export default {
  common: commonFr,
  goods: goodsFr,
  stationHub: stationHubFr,
  quests: questsFr,
  explorationScenes: explorationScenesFr,
  narrativeArcs: narrativeArcsFr,
  narrativeArcsScreen: narrativeArcsScreenFr,
  marketScreen: marketScreenFr,
  combatScreen: combatScreenFr,
  prisonScreen: prisonScreenFr,
  worldEvents: worldEventsFr,
  blackMarket: blackMarketFr,
  travelEvents: travelEventsFr,
  npcTracker: npcTrackerFr,
  chainEvents: chainEventsFr,
  stationEvents: stationEventsFr,
  memoryEvents: memoryEventsFr,
  arrivalSituations: arrivalSituationsFr,
  stalker: stalkerFr,
  bossHomeVisits: bossHomeVisitsFr,
  subBossResolutions: subBossResolutionsFr,
  armors: armorsFr,
  weapons: weaponsFr,
  classes: classesFr,
  runModifiers: runModifiersFr,
  runObjectives: runObjectivesFr,
  metaUnlocks: metaUnlocksFr,
  raphazarus: raphazarusFr,
  pillarRumors: pillarRumorsFr,
  factions: factionsFr,
  ...
  stations: stationsFr,
  nexus: nexusFr,
  wikiScreen: wikiScreenFr,
  factionsScreen: factionsScreenFr,
  introScreen: introScreenFr,
  cinematicIntro: cinematicIntroFr,
  combatOutcomeScreen: combatOutcomeScreenFr,
  interrogationQuestions: interrogationQuestionsFr,
  interrogationScreen: interrogationScreenFr,
  mapScreen: mapScreenFr,
  scenarioGame: scenarioGameFr,
  npcEncounterPanel: npcEncounterPanelFr,
  gameStore: gameStoreFr,
  craftingScreen: craftingScreenFr,
  exploreResultPanel: exploreResultPanelFr,
  wanderResultPanel: wanderResultPanelFr,
  inventoryScreen: inventoryScreenFr,
  nexusScreen: nexusScreenFr,
  questsScreen: questsScreenFr,
  shipWorkshopScreen: shipWorkshopScreenFr,
  travelScreen: travelScreenFr,
  outcomeInterpreter: outcomeInterpreterFr,
  equipmentQuests: equipmentQuestsFr,
  objectivesScreen: objectivesScreenFr,
  consumables: consumablesFr,
  combat: combatFr,
  multiCombat: multiCombatFr,
  minigames: minigamesFr,
  classSelect: classSelectFr,
  combatResultScreen: combatResultScreenFr,
  hubPanels: hubPanelsFr,
  loreScreen: loreScreenFr,
  multiCombatScreen: multiCombatScreenFr,
  stationArrivalScreen: stationArrivalScreenFr,
  metaScreen: metaScreenFr,
  enemies: enemiesFr,
}
